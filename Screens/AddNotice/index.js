...
const AddPoll=(props)=>{
    ...
    setLoading(true)
        AsyncStorage.getItem('userId',(err,userId)=>{
            const uploadData={
                sender,description:text,imgUrl:"",createdBy:userId
            }
            console.log(uploadData)

          createNotice(uploadData).then(res=>{
    ...
    return <View style={{flex:1}}>
         <Header heading="Add Notice" icon="arrowleft" onPress={()=>handleBackPress()}/>
      ...
      {/*   <Popup visible={addoptionPopup}>
        ...
        <ScrollView  showsVerticalScrollIndicator={false}>
         ...
         <View style={{marginTop:30,flex:1}}>
            <Paragraph>Write your notice here?</Paragraph>
            <View style={{marginTop:30,flex:1}}>
                    <Row>
                        <Paragraph>Tell us here more</Paragraph>
                        <Paragraph style={{color:"#959595"}}>{text.length||0}/5000</Paragraph>
                    </Row>
            ...
            <View style={{flexDirection:'row',flex:1,justifyContent:'space-between',alignItems:'center',marginVertical:10}}>
                ...
                <Icon name="pluscircle" color="#EB5C5C" size={30} onPress={()=>{}} />
        </View>
        <View style={{marginBottom:20,minHeight:50}}>
            ...
            <View style={{marginVertical:10,width:'100%'}}>
                                <Title style={{marginLeft:10}}>To whom you want to send notice ?</Title>
                            ...
                            <View style={{width:'100%',marginTop:20}}>
                                <Buttons title="SEND NOTICE" onPress={sendQuery}></Buttons>
                            </View>
            </View>
        </ScrollView>
