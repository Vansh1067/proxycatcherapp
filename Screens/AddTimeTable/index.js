...
const AddTimeTable=(props)=>{
    ...
    const DayPlan=()=>{
        return <View style={{borderColor:'#202020',borderWidth:1,marginVertical:10,padding:10,borderRadius:8}}>
            <Paragraph>MONDAY 10AM-12pm PCS-142 Ashish negi</Paragraph>
        </View>
    }
    return(<View style={{flex:1}}>
       ...
       <View style={{marginTop:20}}>
         ...
         <View style={{flexDirection:'row',flex:1,justifyContent:'space-between',alignItems:'center',marginVertical:20}}>
                ...
                <Icon name="pluscircle" color="#EB5C5C" size={40} onPress={()=>props.navigation.navigate("AddDay")} />
        </View>
        <View style={{minHeight:150}}>
         ...
         <View style={{marginVertical:50}}>
          <Buttons title="Add Time Table" onPress={()=>RegisterHandler()}  />
          </View>
          </ScrollView>
           </Container>
           </View>)
