...
const Dashboard=(props)=>{
    ...
    useEffect(()=>{
      ...
      AsyncStorage.getItem("branch",(err,branch)=>{
        AsyncStorage.getItem('userId',(err,userId)=>{
          getDashboards(branch,userId).then(res=>{
    ...
    return (<View style={{flex:1}}>
        ...
        <View style={{paddingVertical:20}}>
            ...
            <TextCard text1={totalTeachers} text2="Teachers" color="#0C5C8F" onPress={()=>props.navigation.navigate('Teachers',{onlyteacher:false,onlyShow:true})}/>
            <TextCard text1={totalStudents} text2="Students" color="#0E7167" onPress={()=>props.navigation.navigate('Students',{onlyStudent:false,onlyShow:true})}/>
            <View style={{marginVertical:50}}>
            <Title>Check {user==3?"Approvals &":""} Polls</Title>
            <Paragraph style={{marginTop:10,marginBottom:30,fontSize:14,color:"#515762"}}>Check Teacher &amp; Students Polls</Paragraph>
            {<TextCard text2="Polls" text1={polls} color="#EB5C5C"  onPress={()=>{
